...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String moduleName = "emergency";			// 模块名，例：sys
		String subModuleName = "";				// 子模块名（可选） 
		String className = "emergencyMaintenance";			// 类名，例：user
		String tableName ="emergency_maintenance";     //表名
		String classAuthor = "俞超";		// 类作者，例：ThinkGem
		String functionName = "应急维修";			// 功能名，例：用户

		// 是否启用生成工具
		//Boolean isEnable = false;
		Boolean isEnable = true;
		
		Boolean isGenerateController= true;//是否生成Controller
		Boolean isGenerateListView = true; //是否生成列表页面
		Boolean isGenerateFormView = true;//是否生成表单页面
