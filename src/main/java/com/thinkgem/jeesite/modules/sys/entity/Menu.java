...
public class Menu extends IdEntity<Menu> {
	...
	private String isSlide;//是否是左侧显示菜单
	private String isNewMenu;//是否是新建按钮下的菜单
	private String permission; // 权限标识
	private Boolean firstLevelEmpty; //判断第一层菜单是否有子菜单
	...
	@Transient
	public Boolean getFirstLevelEmpty() {
		return firstLevelEmpty;
	}

	public void setFirstLevelEmpty(Boolean firstLevelEmpty) {
		this.firstLevelEmpty = firstLevelEmpty;
	}
	...
	public void setIsNewMenu(String isNewMenu) {
