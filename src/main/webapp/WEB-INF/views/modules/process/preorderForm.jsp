		...
		$(document).ready(function() {
			...
			$("#clientName").typeahead({
			    ...
			    if (current) {
			        ...
			        var clientContacter = current.clientContacter; 
			        $("#clientContacterName").val(typeof clientContacter=="undefined"?"":clientContacter.chineseName);
			        $("#clientContacterId").val(typeof clientContacter=="undefined"?"":clientContacter.id);
			    }
			});
...
<body>
	<div class="wrapper wrapper-content animated fadeInRight">
		...
		<ul class="nav nav-tabs">
			<li><a href="${ctx}/process/preorder">预录单列表</a></li>
			<li class="active"><a href="${ctx}/process/preorder/form">客户公司添加</a></li>
		</ul>
		...
		<form:form id="inputForm" modelAttribute="preorder" action="${ctx}/process/preorder/save" method="post" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input id="clientName" type="text" maxlength="200" class="form-control input-sm" value="${empty preorder.client?'':preorder.client.companyChineseName}" name="client.companyChineseName"/>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input id="clientContacterName" type="text" maxlength="200" class="form-control input-sm" 
						value="${empty preorder.clientContacter?'':preorder.clientContacter.chineseName}" name="clientContacter.chineseName" readonly="readonly"/>
					<input id="clientContacterId" type="hidden" name="clientContacter.id" value="${empty preorder.clientContacter?'':preorder.clientContacter.id}" />
				</div>
			</div>
			<div class="form-group">
