								...
								<div class="assign-item">
									...
									<div>
										<small class="pull-right"> 
											<i class="fa fa-clock-o"></i> 出场时间 <fmt:formatDate value="${processIventory.endTime}" pattern="yyyy/MM/dd"/>
										</small>
										...
										<span> 我们共为您服务<fmt:formatNumber value="${interval/1000/60/60/24}" pattern="#0"/>天.</span>
									</div>
								</div>
